...
func MakeInstallFalco() *cobra.Command {
	...
	falco.Flags().StringArray("set", []string{},
		"Use custom flags or override existing flags \n(example --set falcosidekick.enabled=true)")
...
var FalcoInfoMsg = `
[Falco](https://falco.org) is a *Cloud Native Runtime Security* tool designed to detect anomalous activity in your applications. 
